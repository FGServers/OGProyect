...
<div id="content">
    <table width="560">
        ...
        <tr>
            <th colspan="2"><img src="{dpath}elements/208.gif"></th>
            <th colspan="8"><p style="text-align:left;font-size:14px;">{tut_title_tusk_9}</p> <p style="text-align:left;font-weight:normal;">{tut_tusk_description_mission_9}</p></th>
        </tr>
        <tr>
            <th colspan="10">
                ...
                <ul style="text-align:left;">
                    <li>
                        <span>{tut_tusk_required_mission_9_colony}</span>
                        <span><img src="{dpath}img/{found_colony}.gif" height="11" width="13"></span>
                    </li>
                </ul>
                <div class="Stil2">{tut_tusk_reward_mission_9}</div>
                <br />
