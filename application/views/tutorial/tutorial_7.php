        ...
        <tr>
            <th colspan="10">
                ...
                <div style="top:50px;text-align: left;background:#13181D;border:1px solid #030303;color:#848484;display:none;font-size:10px;padding:20px;width:506px;" id="tutorial_solution">
                    <ul class="solution">
                        <li>En al árbol tecnológico de la sonda de espionaje podrás ver todos los requisitos que necesitas para la construcción. Reúne todas las condiciones previas y posteriormente serás capaz de construir una sonda.</li>
