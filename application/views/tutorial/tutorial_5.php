        ...
        <tr>
            <th colspan="10">
                ...
                <div style="top:50px;text-align: left;background:#13181D;border:1px solid #030303;color:#848484;display:none;font-size:10px;padding:20px;width:506px;" id="tutorial_solution">
                    <ul class="solution">
                        <li>En la vision general del menú puedes cambiar el nombre de tus planetas.</li>
                        ...
                        <li>Si alguno de tus amigos también se ha registrado en OGProyect, lo podrás encontrar utilizando la opción de búsqueda en el encabezado e introduciendo allí su nombre de usuario. Finalmente, haz clic en el símbolo de amigo para enviar una solicitud. Si todavía no conoces a nadie en tu universo, puedes invitar a algún vecino. Cada visita a los sistemas solares ajenos en la visión de la galaxia te cuesta 10 unidades de deuterio.</li>
