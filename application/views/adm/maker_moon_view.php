...
<table width="100%" class="table table-bordered table-hover table-condensed">
	...
	<tr>
		...
		<td>
			<input type="text" name="diameter" maxlength="5">
	...
	<tr>
		...
		<td>
			<input type="text" name="temp_min" maxlength="3" class="input-mini"> <span style="font-size:30px">/</span>
			<input type="text" name="temp_max" maxlength="3" class="input-mini">
	...
	<tr>
		...
		<td>
			<input type="text" name="field_max" maxlength="5" value="1" class="input-xsmall">
		</td>
	</tr>
	<tr>
		<td colspan="2">
