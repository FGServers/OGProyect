<td class=l rowspan="2"><img border='0' src="{dpath}premium/{img_big}.gif" align='top' width='120' height='120'></td>
				...
				<td class=l rowspan="2"><b>{off_name}</b> (<b>{off_status}</b>)<br>
					...
					<table>
						<tr>
						<td><img src="{dpath}premium/{img_small}.gif" width="32" height="32" style="vertical-align:middle;" alt="{off_name}">
						</td>
						<td style='background-color:transparent;'><strong style="color:skyblue; vertical-align:middle;">{off_desc_short}</strong>
						</td>
						</tr>
					</table>
					</div>
