...
<style type="text/css">
 body {margin:-40px auto; padding:0;} 
</style>
<body>
	<div id="start">
	    <div id="header">
                <h1>
                	<img src="application/{game_logo}" width="250px" height="96px">
	...
	<div id="footer">
	    <div id="footerContent">
            <a id="safeplay" href="http://corporate.gameforge.com/en/products/safe-play/" target="_blank"></a>
            <a id="gfLogo" href="http://en.gameforge.com" target="_blank" title="To Gameforge"></a>
            <div id="footerLinks">	
                <a class="" href="http://agbserver.gameforge.com/enGB-Imprint-OGame.html" target="_blank" title="Legal">Legal</a> |
                <a class="" href="http://agbserver.gameforge.com/enGB-Privacy-OGame.html" target="_blank" title="Privacy Policy">Privacy Policy</a> |
                <a class="" href="http://agbserver.gameforge.com/enGB-Terms-OGame.html" target="_blank" title="T&Cs">T&Cs</a> |
                <a href="http://support.en.ogame.gameforge.com/" target="_blank" title="Contact" id="contactLink">Contact</a><br/>
                <div style="text-align:center;">
					<a href="" target="_blank"><div class="socialMediaLogo twitterLogo">Twitter</div></a>
					<a href="" target="_blank"><div class="socialMediaLogo gPlusLogo">Google+</div></a>
					<a href="" target="_blank"><div class="socialMediaLogo fbLogo">Facebook</div></a>
				</div>                
            </div> 
            <p id="copyright">© {year} <a href="http://www.ogproyect.com">OGProyect GmbH</a>. All rights reserved.</p>
        </div>
	</div>
