...
class Fleet2 extends OGPCore
{
	...
	private function build_page()
	{
		...
		// COORDS
		$g 					= ( ( $_POST['galaxy'] == '' ) ? $this->_current_planet['galaxy'] : $_POST['galaxy'] );
		$s 					= ( ( $_POST['system'] == '' ) ? $this->_current_planet['system'] : $_POST['system'] );
		$p 					= ( ( $_POST['planet'] == '' ) ? $this->_current_planet['planet'] : $_POST['planet'] );
		...
		$parse['galaxy'] 				= $this->_current_planet['galaxy'];
		$parse['system'] 				= $this->_current_planet['system'];
		$parse['planet'] 				= $this->_current_planet['planet'];
		...
		$parse['metal'] 				= floor($this->_current_planet['metal']);
		$parse['crystal'] 				= floor($this->_current_planet['crystal']);
		$parse['deuterium'] 			= floor($this->_current_planet['deuterium']);
		$parse['g'] 					= $g;
		$parse['s'] 					= $s;
		$parse['p'] 					= $p;
		...
		$colony['shortcut_options']	= Functions_Lib::build_planet_list ( $this->_current_user , $this->_current_planet['id'] );
