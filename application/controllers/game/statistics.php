...
class Statistics extends OGPCore
{
	const MODULE_ID	= 16;
	...
	private function build_page()
	{
		...
		if ( $who == 2 )
		{
			...
			while ( $StatRow = parent::$db->fetch_assoc ( $query ) )
			{
				...
				$parse['ally_action']		  	= $StatRow['ally_request_notallow'] == 0 ? '<a href="game.php?page=alliance&mode=apply&allyid=' . $StatRow['alliance_id'] . '"><img src="' . DPATH . 'img/m.gif" border="0" title="' . $this->_lang['st_ally_request'] . '" /></a>' : '';
