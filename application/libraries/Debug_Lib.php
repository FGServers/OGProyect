...
class Debug_Lib extends OGPCore
{
	private $log;
	private $numqueries;
	private $_lang;
	...
	{
		return  '<br><table><tr><td class="k" colspan="2"><a href="' . OGP_ROOT . 'admin.php?page=settings">Debug Log</a>:</td></tr>' . $this->log . '</table>';
	}
		...
		else
		{
			...
			echo '<!DOCTYPE html>
					<html lang=en>
					  ...
					  <a href=//www.google.com/><img src="http://www.ogproyect.com/images/misc/xg-logo.png" alt="OG Proyect"></a>
	...
	{
		$file	=	OGP_ROOT . LOGS_PATH . $log_file . ".php";
