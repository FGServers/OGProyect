...
if ( ! defined ( 'INSIDE' ) ) die ( header ( "location:../" ) ) ;
	...
	define('DEFAULT_SKINPATH' 		 	, 'application/styles/skins/ogproyect/');
	define('JS_PATH'					, 'js/');
	...
	// BATTLE ENGINE PATHS
	define('BATTLE_ENGINE_PATH'			, 'application/libraries/' );
	define('BATTLE_ENGINE_CORE'			, BATTLE_ENGINE_PATH .'battle_engine/');
