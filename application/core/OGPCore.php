...
abstract class OGPCore
{
	...
	{
		require_once ( OGP_ROOT. '/application/core/Language.php' );
	...
	{
		require_once ( OGP_ROOT . '/application/libraries/Users_Lib.php' );
	...
	{
		require_once ( OGP_ROOT. '/application/core/Objects.php' );
	...
	{
		require_once ( OGP_ROOT. '/application/libraries/Template_Lib.php' );
