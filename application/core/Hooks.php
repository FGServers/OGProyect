...
class Hooks
{
	...
	function initialize()
	{
		...
		if ( is_file ( OGP_ROOT . 'application/config/hooks.php' ) )
		{
			include ( OGP_ROOT . 'application/config/hooks.php' );
		}
	...
	function run_hook ( $data )
	{
		...
		$filepath = OGP_ROOT . 'application/' . $data['filepath'] . '/' . $data['filename'];
