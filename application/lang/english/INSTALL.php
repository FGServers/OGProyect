...
$lang['ins_no_server_requirements']	= 'Your server / hosting does not meet the minimum requirements needed to run OG Proyect.<br /><br />Requisitos: <br />- PHP 5.3.0<br />- MySQL 5.0.19';
$lang['ins_already_installed']		= 'OG Proyect is already installed. Select an option: <br /><br /> - <a href="index.php?page=update">Update</a> <br /> - <a href="index.php?page=migrate">Migrate</a> <br /> - <a href="../">Back to the game</a> <br /><br />In case you do not want to take any action, for safety, we recommend <span style="color:red;text-decoration:underline;">DELETE</span> the install directory.';
...
$lang['ins_welcome']				= 'Welcome to OG Proyect!';
$lang['ins_welcome_first_line']		= 'OG Proyect is one of the best OGame clones. OG Proyect 1.0 is the last and most stable package never before developed. As any other version, OG Proyect receives support from the team known as XGProyect, always making sure to get the best quality care and the stability of the release.. OG Proyect 3 day by day looks forward; growth, stability, flexibility, dynamism, quality and user confidence. We\'re always expecting that OG Proyect is better than your expectations.';
$lang['ins_welcome_second_line']	= 'The installation system will guide you through the installation or upgrading from a previous version to the latest. For doubts, problems o queries, do not hesitate to see our <a href="http://www.ogproyect.net/"><em>support and development community</em></a>.';
$lang['ins_welcome_third_line']		= 'OG Proyect is an OpenSource project, to see the license specifications click over license in the main menu. To start the installation click on the install button or click on the update button to start the upgrade to a newest version.';
