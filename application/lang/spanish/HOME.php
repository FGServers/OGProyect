...
$lang['hm_description']						= 'OG Proyect - ¡El juego legendario en el espacio! Descubre un universo junto con miles de jugadores.';
...
$lang['hm_hidden_title']					= 'OGProyect - Conquista el universo';
...
$lang['hm_home']							= 'Home';
$lang['hm_about']							= 'Sobre OGP';
$lang['hm_media']							= 'Media';
$lang['hm_forum']							= 'Foro';

// ajax - home
$lang['aj_home_conquer_universe']			= 'OG Proyect - Conquista el universo';
$lang['aj_home_description']				= '<em>OG Proyect</em> es un juego de estrategia localizado en el espacio. Miles de jugadores por todo el mundo compiten al mismo tiempo. Para jugar sólo necesitas un navegador web.';
$lang['aj_home_rules']						= 'Reglas';
$lang['aj_home_trailer']					= 'Trailer';

// ajax - about
$lang['aj_info_about_title']				= 'OG Proyect es un juego de conquista intergaláctica.';
$lang['aj_info_about_description']			= '<em>OG Proyect</em> es un juego de estrategia localizado en el espacio. Miles de jugadores por todo el mundo compiten al mismo tiempo. Para jugar sólo necesitas un navegador web.';
$lang['aj_info_features']					= 'Características';
$lang['aj_info_description_line1']			= 'Empiezas con un mundo por desarrollar que se convertirá en un <em>poderoso imperio</em> capaz de defender tus colonias conquistadas con gran esfuerzo.';
$lang['aj_info_description_line2']			= 'Crea una <em>infraestructura económica y militar</em> para ayudarte en tu misión hacia el siguiente y mayor avance tecnológico.';
$lang['aj_info_description_line3']			= '<em>Dirige guerras</em> contra otros imperios a medida que luchas contra otros jugadores para conseguir recursos.';
$lang['aj_info_description_line4']			= '<em>Negocia</em> con otros emperadores y crea una alianza o comercia esos recursos que tanto necesitas.';
$lang['aj_info_description_line5']			= '<em>Construye una armada</em> para garantizar que se cumple tu voluntad en todo el universo.';
$lang['aj_info_description_line6']			= '<em>Protege tus recursos</em> tras un muro de defensas planetarias impenetrable.';
$lang['aj_info_description_line7']			= '<em>OG Proyect</em> te ofrece <em>posibilidades infinitas.</em>';
$lang['aj_info_description_line8']			= '¿Sembrarás el terror allá por donde vayas? ¿O harás temblar de miedo a aquellos que osen atacar al indefenso?';
$lang['aj_info_team']						= 'Equipo';
$lang['aj_info_credits']					= 'Créditos';
$lang['aj_info_images']						= 'Imágenes';

// ajax - media
$lang['aj_media_wallpapers']				= 'Fondos de pantalla';
$lang['aj_media_pictures']					= 'Imágenes';
$lang['aj_media_concept_art']				= 'Arte conceptual';

// registration
$lang['re_disabled']						= 'En estos momentos el registro a nuevos usuarios se encuentra cerrado.';
$lang['re_mail_text_part1']					= '¡Bienvenido a OG Proyect, gracias por unirte en nuestro juego!<br/> En este email encontrarás toda la información que necesitarás para acceder a tu cuenta';
...
$lang['re_mail_text_part7']					= 'Atentamente,<br/>El equipo de OGP.-';
$lang['re_mail_register_at']				= 'Registro en OG Proyect';

// message for new users
$lang['re_welcome_message_from']			= 'Admin';
$lang['re_welcome_message_subject']			= '¡Te damos la bienvenida a OGProyect!';
$lang['re_welcome_message_content']			= 'Hola %s - ¡Bienvenido a OGProyect!
<br/><br/>
...
O puedes pedir ayuda en el canal de soporte de IRC: #OGProyect.net y #OGProyect.net-support en:<br/>
<a href="game.php?page=chat">IRC chat</a><br/>
<br/><br/>
