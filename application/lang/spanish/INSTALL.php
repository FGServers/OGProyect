...
$lang['ins_no_server_requirements']	= 'Tu servidor/hosting no cumple con los requisitos m&iacute;nimos que requiere OG Proyect para funcionar.<br /><br />Requisitos: <br />- PHP 5.2.0<br />- MySQL 5.0.19';
$lang['ins_already_installed']		= 'OG Proyect ya se encuentra instalado. Selecciona una opci&oacute;n: <br /><br /> - <a href="index.php?page=update">Actualizar</a> <br /> - <a href="index.php?page=migrate">Migrar</a> <br /> - <a href="../">Volver al juego</a> <br /><br />En el caso de que no desees realizar ninguna acci&oacute;n, por seguridad, te recomendamos <span style="color:red;text-decoration:underline;">BORRAR</span> el directorio install.';
...
$lang['ins_welcome']				= '&iexcl;Bienvenido a OG Proyect!';
$lang['ins_welcome_first_line']		= 'OG Proyect es uno de los mejores clones de OGame existentes hasta el momento. OG Proyect 1.0 es el &uacute;ltimo y m&aacute;s estable paquete nunca antes desarrollado. Tal cual como las otras versiones, OG Proyect recibe soporte del equipo antes conocido como XGProyect, asegur&aacute;ndonos siempre de lograr la mejor calidad en atenci&oacute;n y la estabilidad de la versi&oacute;n. OG Proyect 3 d&iacute;a a d&iacute;a busca; crecimiento, estabilidad, flexibilidad, dinamismo, calidad y la confianza del usuario en que es su mejor opci&oacute;n y elecci&oacute;n. Siempre esperamos que OG Proyect sea mejor que sus expectativas.';
$lang['ins_welcome_second_line']	= 'El sistema de instalaci&oacute;n te guiar&aacute; a trav&eacute;s de la instalaci&oacute;n del mismo, o la actualizaci&oacute;n de una versi&oacute;n anterior a la m&aacute;s reciente. Cualquier duda, problema o consulta no dudes en consulta nuestra <a href="http://www.ogproyect.net/"><em>comunidad de desarrollo y soporte</em></a>.';
$lang['ins_welcome_third_line']		= 'OG Proyect es un proyecto OpenSource (c&oacute;digo abierto), para ver las especificaciones de la licencia haz click en licencia en la barra superior. Para comenzar la instalaci&oacute;n haz click en el bot&oacute;n instalar o para actualizar a la versi&oacute;n m&aacute;s nueva haz click en el bot&oacute;n actualizar.';
